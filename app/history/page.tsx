    ...
    <SiteShell activePath="/league-info">
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8" aria-labelledby="history-title">
          <Link href="/league-info" className="inline-flex min-h-11 items-center gap-2 rounded-lg px-2 py-2 text-xs font-black uppercase tracking-widest text-slate-600 transition hover:text-orange-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 focus-visible:ring-offset-2">
            ← Back to League Info
          </Link>
