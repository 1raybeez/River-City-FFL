  ...
  return (
    <SiteShell activePath="/league-info">
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-12">
        ...
        <section className="mt-6 rounded-2xl border border-[#cbd5e1] bg-[#071a33] p-5 text-white shadow-sm sm:flex sm:items-center sm:justify-between sm:gap-8 sm:p-6" aria-labelledby="trophy-room-callout-title">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-amber-300">Trophy Room</p>
            <h2 id="trophy-room-callout-title" className="mt-2 text-2xl font-black tracking-tight">Explore the Trophy Room</h2>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-200">Every River City champion by season, career podium finishes, and league infamy.</p>
          </div>
          <Link href="/league-info/trophy-room" className="mt-4 inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg border border-amber-300/70 px-4 py-3 text-xs font-black uppercase tracking-widest text-amber-200 transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300 focus-visible:ring-offset-2 focus-visible:ring-offset-[#071a33] sm:mt-0">Visit the Trophy Room <span aria-hidden="true" className="ml-2">→</span></Link>
        </section>
