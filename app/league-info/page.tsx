      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <section aria-labelledby="season-title" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <Link href="/league-info/draft" className="mt-5 inline-flex min-h-11 items-center gap-2 text-xs font-black uppercase tracking-widest text-orange-700 underline decoration-orange-300 underline-offset-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600">View draft details <ArrowRight size={15} aria-hidden="true" /></Link>
          </section>
