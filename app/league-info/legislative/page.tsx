      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mt-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8" aria-labelledby="legislative-title">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Link href={authenticated ? '/league-info/legislative/new' : '/member/login?returnTo=%2Fleague-info%2Flegislative%2Fnew'} className="inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg bg-orange-600 px-4 py-3 text-[10px] font-black uppercase tracking-widest text-white hover:bg-orange-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600">{authenticated ? 'Submit Proposal' : 'Log in to submit'}</Link>
          </div>
        </section>
