...
export default function ReportCardOverview({ reportIndex, ownerMode = false, ownerFranchiseId }: { reportIndex: CommissionerPostDraftReportRow[]; ownerMode?: boolean; ownerFranchiseId?: string | null }) {
