...
assert.match(ownerPage, /\/member\/login\?returnTo=%2Fleague-info%2Fdraft-report/);
assert.match(overviewPage, /getOwnerDraftReportCardOverview/);
assert.match(overviewPage, /\/member\/login\?returnTo=%2Fleague-info%2Fdraft-report%2Foverview/);
...
assert.match(view, /external reference/);
assert.doesNotMatch(view, /below market|above market/);
