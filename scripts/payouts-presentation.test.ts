...
assert.doesNotMatch(client, /Who has paid|Owner dues status|duesRows/);
...
assert.match(client, /season\.weeklyAwards\.reduce/);
assert.match(client, /Weekly prizes \(\{season\.weeklyAwards\.length\}\)/);
