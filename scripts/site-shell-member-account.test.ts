...
assert.match(accountMenu, /Commissioner Hub/);
assert.match(accountMenu, /signOutControl/);
...
assert.doesNotMatch(`${shell}\n${accountMenu}`, /email|firebaseUid|canonicalOwnerId|warRoomId|rosterId|idToken|targets|notes|budget|finance/i);
