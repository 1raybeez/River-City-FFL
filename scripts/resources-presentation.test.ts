...
assert.match(page, /name: "DraftSharks"/);
assert.match(page, /desc: "Fantasy football rankings, projections, draft tools, and analysis for preseason and in-season research\."/);
