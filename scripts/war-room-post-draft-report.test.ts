...
assert.match(page, /Draft Grade/);
assert.match(page, /Draft Score/);
assert.match(page, /Strategy Execution/);
assert.match(page, /Power Rank Context/);
assert.match(page, /not playoff odds or win probability/);
assert.match(page, /Total spend/);
assert.match(page, /Remaining/);
assert.match(page, /Best Buy/);
assert.match(page, /Biggest Reach/);
assert.match(page, /Roster Construction/);
assert.match(page, /Keepers/);
...
assert.match(page, /Private War Room Analysis/);
assert.match(page, /Position Spend/);
assert.match(page, /Coverage & Warnings/);
assert.doesNotMatch(page, /preferredEntry|additionalNotes|riskTolerance/);
assert.doesNotMatch(page, /calculatePublicDraftGrades|calculateStrategyExecution/);
