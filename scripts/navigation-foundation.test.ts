...
assert.equal(PRIMARY_SITE_NAV_ITEMS.some((item) => item.href === "/history"), false);
assert.equal(PRIMARY_SITE_NAV_ITEMS.some((item) => item.href === "/league-info/rivalries"), false);
